...
//   public static numberOfStatesForTest(a: ITestResultContainer): number {
//     let n = 0

//     if (a.TestResults) {
//       n += a.TestResults.reduce((a, b) => a + b.States.length, 0)
//     }

//     if (a.TestClasses) {
//       for (let i of a.TestClasses) {
//         n += Utils.numberOfStatesForTest(i)
//       }
//     }
...
//   public static getTestResults(a: ITestResultContainer): ITestResult[] {
//     let n: ITestResult[] = []
...
//     if (a.TestClasses) {
//       for (let i of a.TestClasses) {
//         n = n.concat(Utils.getTestResults(i))
//       }
//     }
