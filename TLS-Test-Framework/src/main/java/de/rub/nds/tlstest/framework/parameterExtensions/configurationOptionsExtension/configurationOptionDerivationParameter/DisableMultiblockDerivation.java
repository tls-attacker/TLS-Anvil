...
public class DisableMultiblockDerivation extends ConfigurationOptionDerivationParameter {
    public DisableMultiblockDerivation() {
        super(ConfigOptionParameterType.DISABLE_MULTIBLOCK);
    }
    ...
    public List<DerivationParameter<Config, ConfigurationOptionValue>> getParameterValues(
        ...
        List<DerivationParameter<Config, ConfigurationOptionValue>> parameterValues =
                new LinkedList<>();
        parameterValues.add(new DisableMultiblockDerivation(new ConfigurationOptionValue(false)));
        parameterValues.add(new DisableMultiblockDerivation(new ConfigurationOptionValue(true)));
    ...
    protected DerivationParameter<Config, ConfigurationOptionValue> generateValue(
        ...
        return new DisableMultiblockDerivation(selectedValue);
    }
}
