...
public class DisableRdrandDerivation extends ConfigurationOptionDerivationParameter {
    public DisableRdrandDerivation() {
        super(ConfigOptionParameterType.DISABLE_RDRAND);
    }
    ...
    public List<DerivationParameter<Config, ConfigurationOptionValue>> getParameterValues(
        ...
        List<DerivationParameter<Config, ConfigurationOptionValue>> parameterValues =
                new LinkedList<>();
        parameterValues.add(new DisableRdrandDerivation(new ConfigurationOptionValue(false)));
        parameterValues.add(new DisableRdrandDerivation(new ConfigurationOptionValue(true)));
    ...
    protected DerivationParameter<Config, ConfigurationOptionValue> generateValue(
        ...
        return new DisableRdrandDerivation(selectedValue);
    }
}
