...
public class PSKKeyExchangeModesExtension extends TlsLengthfieldTest {
    ...
    public void pskKeyExchangeModesExtensionLength(AnvilTestCase testCase, WorkflowRunner runner) {
        Config config = context.getConfig().createTls13Config();
        config.setAddPSKKeyExchangeModesExtension(true);
        genericExtensionLengthTest(
                runner, testCase, config, PSKKeyExchangeModesExtensionMessage.class);
    }
