...
public class EarlyData extends Tls13Test {
    ...
    public ConditionEvaluationResult supports0rtt() {
        if (context.getSiteReport().getResult(TlsAnalyzedProperty.SUPPORTS_TLS13_0_RTT) == TestResult.TRUE) {
    ...
    public ConditionEvaluationResult tls13multipleCipherSuites() {
        if (context.getSiteReport().getResult(TlsAnalyzedProperty.SUPPORTS_TLS13_0_RTT) == TestResult.TRUE && context.getSiteReport().getSupportedTls13CipherSuites() != null && context.getSiteReport().getSupportedTls13CipherSuites().size() > 1) {
            return ConditionEvaluationResult.enabled("");
        } else {
